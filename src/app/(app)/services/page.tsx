    ...
    <div className="space-y-8">
      ...
      {services.length === 0 ? (
        ...
        <Card className="shadow-lg rounded-lg">
          <CardHeader>
            <CardTitle className="font-headline">Service List</CardTitle>
            <CardDescription className="font-body">A list of all services offered.</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="font-headline">Available At</TableHead>
                ...
                {services.map((service) => (
                  <TableRow key={service.id} className="font-body">
                    <TableCell className="font-medium text-foreground">
                      {service.name}
                      <p className="text-xs text-muted-foreground mt-1 truncate max-w-xs">{service.description}</p>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-1.5"><DollarSign size={12} className="text-primary"/> R {service.price.toFixed(2)}</div>
                      <div className="flex items-center gap-1.5 mt-1 text-muted-foreground text-xs"><Clock size={12} className="text-primary"/> {service.durationMinutes} min</div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Badge variant={service.isActive ? "default" : "destructive"} className={service.isActive ? 'bg-green-100 text-green-800 border-green-200' : 'bg-red-100 text-red-800 border-red-200'}>
